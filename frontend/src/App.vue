  ...
  <div id="wrapper">
    <nav class="navbar is-dark">
      <div class="navbar-brand">
        <router-link to="/" class="navbar-item"><strong>T-shop</strong></router-link>
    ...
    <div class="navbar-menu" id="navbar-menu" v-bind:class="{'is-active': showMobileMenu }">
          ...
          <div class="navbar-item">
            <form method="get" action="/search">
              <div class="field has-addons">
                <div class="control">
                  <input type="text" class="input" placeholder="Αναζήτηση..." name="query">
                </div>
      ...
      <div class="navbar-end">
        ...
        <router-link to="/unisex" class="navbar-item">Unisex</router-link>
